...
![tests](https://img.shields.io/badge/tests-2816%2F2816%20green-brightgreen)
...
The full regression gate is **2816/2816 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 2816/2816
```
