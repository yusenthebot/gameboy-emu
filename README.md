...
![tests](https://img.shields.io/badge/tests-438%2F438%20green-brightgreen)
...
The full regression gate is **438/438 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 438/438
```
