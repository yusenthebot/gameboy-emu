...
![tests](https://img.shields.io/badge/tests-2027%2F2027%20green-brightgreen)
...
The full regression gate is **2027/2027 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 2027/2027
```
