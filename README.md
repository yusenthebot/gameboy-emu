...
![tests](https://img.shields.io/badge/tests-1672%2F1672%20green-brightgreen)
...
The full regression gate is **1672/1672 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 1672/1672
```
