...
![tests](https://img.shields.io/badge/tests-1514%2F1514%20green-brightgreen)
...
The full regression gate is **1514/1514 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 1514/1514
```
