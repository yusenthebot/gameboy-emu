...
![tests](https://img.shields.io/badge/tests-113%2F113%20green-brightgreen)
...
The full regression gate is **113/113 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 113/113
```
