...
![tests](https://img.shields.io/badge/tests-2821%2F2821%20green-brightgreen)
...
The full regression gate is **2821/2821 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 2821/2821
```
