...
![tests](https://img.shields.io/badge/tests-130%2F130%20green-brightgreen)
...
The full regression gate is **130/130 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 130/130
```
