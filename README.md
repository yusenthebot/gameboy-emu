...
![tests](https://img.shields.io/badge/tests-2645%2F2645%20green-brightgreen)
...
The full regression gate is **2645/2645 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 2645/2645
```
