...
![tests](https://img.shields.io/badge/tests-1592%2F1592%20green-brightgreen)
...
The full regression gate is **1592/1592 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 1592/1592
```
