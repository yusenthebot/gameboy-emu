...
![tests](https://img.shields.io/badge/tests-115%2F115%20green-brightgreen)
...
The full regression gate is **115/115 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 115/115
```
