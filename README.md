...
![tests](https://img.shields.io/badge/tests-397%2F397%20green-brightgreen)
...
The full regression gate is **397/397 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 397/397
```
