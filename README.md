...
![tests](https://img.shields.io/badge/tests-715%2F715%20green-brightgreen)
...
The full regression gate is **715/715 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 715/715
```
