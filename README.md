...
![tests](https://img.shields.io/badge/tests-455%2F455%20green-brightgreen)
...
The full regression gate is **455/455 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 455/455
```
