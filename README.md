...
![tests](https://img.shields.io/badge/tests-495%2F495%20green-brightgreen)
...
The full regression gate is **495/495 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 495/495
```
