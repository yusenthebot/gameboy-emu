...
![tests](https://img.shields.io/badge/tests-796%2F796%20green-brightgreen)
...
The full regression gate is **796/796 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 796/796
```
