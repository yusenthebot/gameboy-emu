...
![tests](https://img.shields.io/badge/tests-262%2F262%20green-brightgreen)
...
The full regression gate is **262/262 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 262/262
```
