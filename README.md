...
![tests](https://img.shields.io/badge/tests-1395%2F1395%20green-brightgreen)
...
The full regression gate is **1395/1395 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 1395/1395
```
