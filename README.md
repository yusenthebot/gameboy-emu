...
![tests](https://img.shields.io/badge/tests-1942%2F1942%20green-brightgreen)
...
The full regression gate is **1942/1942 green** (`tools/run_tests.sh`). Every check is
...
./tools/run_tests.sh                  # -> PASS: 1942/1942
```
